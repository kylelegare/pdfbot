...
with col1:
    st.image("pdfbot.png")
with col2:
    st.markdown("<div style='text-align: center;'><h1>PDF Bot</h1><div style='margin-top: 1px;'><p style='font-size: 24px;'><em>AI-Powered Search For Any PDF</em></p></div></div>", unsafe_allow_html=True)
