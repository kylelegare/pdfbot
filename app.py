...
with col1:
    st.image("pdfbot.png")
with col2:
    st.markdown("<div style='text-align: center'><h1>PDF Bot</h1><div style='margin-top: 3px;'><p style='font-size: 24px; font-style: italic;'>AI-Powered Search</p><p style='font-size: 24px;'>For Any PDF</p></div></div>", unsafe_allow_html=True)
